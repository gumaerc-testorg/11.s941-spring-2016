...
The diagrams do not need to follow a specific structure; please view {{% resource_link "0f8fabc6-a386-4fed-9af8-1c70ce759c43" "pathway diagram examples from Human Impact Partners(PDF)" %}}.

Critique of published HIA (individual assignment 500–700 words)
---------------------------------------------------------------

Read through several {{% resource_link "c83a84c0-7188-4e15-bf83-411685ade5af" "published HIAs from the Pew Charitable Trust website" %}}, and choose one to critique.
